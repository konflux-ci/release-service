...
require (
	...
	github.com/konflux-ci/coverport/instrumentation/go v0.0.0-20260211105904-c7bde8011bf1
	github.com/konflux-ci/integration-service v0.0.0-20260211144343-b1e7afdbb57d
