...
require (
	...
	github.com/konflux-ci/coverport/instrumentation/go v0.0.0-20260226124752-74868db64906
	github.com/konflux-ci/integration-service v0.0.0-20260306105156-daf25a3fd53c
