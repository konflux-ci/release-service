...
type RetryInfo struct {
	...
	// DisablingTags is the list of tags from the ReleaseServiceConfig that disable retries on match.
	// +optional
	DisablingTags []string `json:"disablingTags,omitempty"`
...
// GetDisablingTags returns the disabling tags from RetryInfo or nil if not configured.
func (rpa *ReleasePlanAdmission) GetDisablingTags() []string {
	if rpa.Status.RetryInfo == nil {
		return nil
	}
	return rpa.Status.RetryInfo.DisablingTags
}
