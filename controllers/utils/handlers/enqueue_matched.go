...
type EnqueueRequestForMatchedResource = TypedEnqueueRequestForMatchedResource[client.Object]

type TypedEnqueueRequestForMatchedResource[object client.Object] struct{}

// Create implements EventHandler.
func (e *TypedEnqueueRequestForMatchedResource[T]) Create(_ context.Context, _ event.TypedCreateEvent[T], _ workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	// A freshly created resource won't have any resources in its status
}

// Update implements EventHandler.
func (e *TypedEnqueueRequestForMatchedResource[T]) Update(_ context.Context, updateEvent event.TypedUpdateEvent[T], rateLimitingInterface workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (e *TypedEnqueueRequestForMatchedResource[T]) Delete(_ context.Context, deleteEvent event.TypedDeleteEvent[T], rateLimitingInterface workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (e *TypedEnqueueRequestForMatchedResource[T]) Generic(_ context.Context, genericEvent event.TypedGenericEvent[T], rateLimitingInterface workqueue.TypedRateLimitingInterface[reconcile.Request]) {
