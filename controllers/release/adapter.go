...
func (a *adapter) EnsureManagedCollectorsPipelineIsProcessed() (controller.OperationResult, error) {
	...
	tenantRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.CollectorsProcessing.ManagedCollectorsProcessing, "tenant")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}

	managedRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.CollectorsProcessing.ManagedCollectorsProcessing, "managed")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}

	secretRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.CollectorsProcessing.ManagedCollectorsProcessing, "secret")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}
...
func (a *adapter) EnsureTenantCollectorsPipelineIsProcessed() (controller.OperationResult, error) {
	...
	tenantRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.CollectorsProcessing.TenantCollectorsProcessing, "tenant")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}

	secretRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.CollectorsProcessing.TenantCollectorsProcessing, "secret")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}
...
func (a *adapter) EnsureManagedPipelineIsProcessed() (controller.OperationResult, error) {
	...
	tenantRoleBinding, _ := a.loader.GetRoleBindingFromReleaseStatusPipelineInfo(a.ctx, a.client, &a.release.Status.ManagedProcessing, "tenant")
	if err != nil && !errors.IsNotFound(err) && !strings.Contains(err.Error(), "valid reference to a RoleBinding") {
		return controller.RequeueWithError(err)
	}
